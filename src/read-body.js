...
// exceeds `limit` bytes — an untrusted host must never stream unbounded data.
// Shared by every transport (range + gateway); verification happens above.
import { VerificationError } from './verify.js';

export async function readBody(res, limit) {
