#!/usr/bin/env node
// Assemble the static v0.3.1 package. The PMTiles archives and their proof
...
async function main() {
  ...
  console.log('dist/: every archive, proof, style, and font asset verified with veritiles v0.3.1');
}
